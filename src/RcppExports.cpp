...
#include "../inst/include/rangertsModified.h"
#include <RcppEigen.h>
#include <Rcpp.h>
...
static const R_CallMethodDef CallEntries[] = {
    {"_rangertsModified_rangertsCpp", (DL_FUNC) &_rangertsModified_rangertsCpp, 52},
    {"_rangertsModified_numSmaller", (DL_FUNC) &_rangertsModified_numSmaller, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_rangertsModified(DllInfo *dll) {
