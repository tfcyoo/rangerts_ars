...
#include "../inst/include/rangertsARS.h"
#include <RcppEigen.h>
#include <Rcpp.h>
...
// rangertsCpp
Rcpp::List rangertsCpp(uint treetype, Rcpp::NumericMatrix input_x_ar_sieve, Rcpp::NumericMatrix input_x, Rcpp::NumericMatrix input_y, std::vector<std::string> variable_names, uint mtry, uint num_trees, bool verbose, uint seed, uint num_threads, bool write_forest, uint importance_mode_r, uint min_node_size, std::vector<std::vector<double>>& split_select_weights, bool use_split_select_weights, std::vector<std::string>& always_split_variable_names, bool use_always_split_variable_names, bool prediction_mode, Rcpp::List loaded_forest, Rcpp::RawMatrix snp_data, bool sample_with_replacement, bool probability, std::vector<std::string>& unordered_variable_names, bool use_unordered_variable_names, bool save_memory, uint splitrule_r, std::vector<double>& case_weights, bool use_case_weights, std::vector<double>& class_weights, bool predict_all, bool keep_inbag, std::vector<double>& sample_fraction, double alpha, double minprop, bool holdout, uint prediction_type_r, uint num_random_splits, Eigen::SparseMatrix<double>& sparse_x, bool use_sparse_data, bool order_snps, bool oob_error, uint max_depth, std::vector<std::vector<size_t>>& inbag, bool use_inbag, std::vector<double>& regularization_factor, bool use_regularization_factor, bool regularization_usedepth, uint bootstrap_ts_r, bool by_end, uint block_size, uint period, std::vector<double>& errors, std::vector<double>& coefs);
RcppExport SEXP _rangertsARS_rangertsCpp(SEXP treetypeSEXP, SEXP input_x_ar_sieveSEXP, SEXP input_xSEXP, SEXP input_ySEXP, SEXP variable_namesSEXP, SEXP mtrySEXP, SEXP num_treesSEXP, SEXP verboseSEXP, SEXP seedSEXP, SEXP num_threadsSEXP, SEXP write_forestSEXP, SEXP importance_mode_rSEXP, SEXP min_node_sizeSEXP, SEXP split_select_weightsSEXP, SEXP use_split_select_weightsSEXP, SEXP always_split_variable_namesSEXP, SEXP use_always_split_variable_namesSEXP, SEXP prediction_modeSEXP, SEXP loaded_forestSEXP, SEXP snp_dataSEXP, SEXP sample_with_replacementSEXP, SEXP probabilitySEXP, SEXP unordered_variable_namesSEXP, SEXP use_unordered_variable_namesSEXP, SEXP save_memorySEXP, SEXP splitrule_rSEXP, SEXP case_weightsSEXP, SEXP use_case_weightsSEXP, SEXP class_weightsSEXP, SEXP predict_allSEXP, SEXP keep_inbagSEXP, SEXP sample_fractionSEXP, SEXP alphaSEXP, SEXP minpropSEXP, SEXP holdoutSEXP, SEXP prediction_type_rSEXP, SEXP num_random_splitsSEXP, SEXP sparse_xSEXP, SEXP use_sparse_dataSEXP, SEXP order_snpsSEXP, SEXP oob_errorSEXP, SEXP max_depthSEXP, SEXP inbagSEXP, SEXP use_inbagSEXP, SEXP regularization_factorSEXP, SEXP use_regularization_factorSEXP, SEXP regularization_usedepthSEXP, SEXP bootstrap_ts_rSEXP, SEXP by_endSEXP, SEXP block_sizeSEXP, SEXP periodSEXP, SEXP errorsSEXP, SEXP coefsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< uint >::type treetype(treetypeSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type input_x_ar_sieve(input_x_ar_sieveSEXP);
    ...
    Rcpp::traits::input_parameter< uint >::type bootstrap_ts_r(bootstrap_ts_rSEXP);
    Rcpp::traits::input_parameter< bool >::type by_end(by_endSEXP);
    Rcpp::traits::input_parameter< uint >::type block_size(block_sizeSEXP);
    Rcpp::traits::input_parameter< uint >::type period(periodSEXP);
    Rcpp::traits::input_parameter< std::vector<double>& >::type errors(errorsSEXP);
    Rcpp::traits::input_parameter< std::vector<double>& >::type coefs(coefsSEXP);
    rcpp_result_gen = Rcpp::wrap(rangertsCpp(treetype, input_x_ar_sieve, input_x, input_y, variable_names, mtry, num_trees, verbose, seed, num_threads, write_forest, importance_mode_r, min_node_size, split_select_weights, use_split_select_weights, always_split_variable_names, use_always_split_variable_names, prediction_mode, loaded_forest, snp_data, sample_with_replacement, probability, unordered_variable_names, use_unordered_variable_names, save_memory, splitrule_r, case_weights, use_case_weights, class_weights, predict_all, keep_inbag, sample_fraction, alpha, minprop, holdout, prediction_type_r, num_random_splits, sparse_x, use_sparse_data, order_snps, oob_error, max_depth, inbag, use_inbag, regularization_factor, use_regularization_factor, regularization_usedepth, bootstrap_ts_r, by_end, block_size, period, errors, coefs));
    return rcpp_result_gen;
END_RCPP
}
// numSmaller
Rcpp::IntegerVector numSmaller(Rcpp::NumericVector values, Rcpp::NumericVector reference);
RcppExport SEXP _rangertsARS_numSmaller(SEXP valuesSEXP, SEXP referenceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_rangertsARS_rangertsCpp", (DL_FUNC) &_rangertsARS_rangertsCpp, 53},
    {"_rangertsARS_numSmaller", (DL_FUNC) &_rangertsARS_numSmaller, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_rangertsARS(DllInfo *dll) {
